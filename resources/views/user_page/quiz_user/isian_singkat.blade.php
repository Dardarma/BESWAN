                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{url('/user/quiz/kerjakan/pilihan_ganda/'.$quiz_user->quiz_user_id)}}" type="button" class="btn btn-primary sm mx-1" style="border-radius: 5px;">
                                Pilihan Ganda
                            </a>
                            <a href="{{url('/user/quiz/kerjakan/uraian/'.$quiz_user->quiz_user_id)}}" type="button" class="btn btn-primary sm mx-1" style="border-radius: 5px;">
                                Uraian
                            </a>
                        </div>
                    </div>
