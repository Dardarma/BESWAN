    ...
    <div class="row">
        ...
        <div class="container my-5 mx-2">
            <div class="row">
                ...
                <div class="card-body col-md-3 col-6 mx-2" style="background-color: blue; border-radius: 10px; padding: 10px; color:white; cursor: pointer;" onclick="window.location.href='{{ url('user/quiz/'.$item->id) }}'">
                    ...
                    <div class="card-text d-flex justify-content-start align-items-center my-2">
                        <table>
                            ...
                            @php
                                ...
                                }else if($type->tipe_soal == 'isian_singkat'){
