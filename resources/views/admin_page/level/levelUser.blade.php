            ...
            <div class="card mt-4">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-12 col-md-auto mb-2 mb-md-0">
                            <h3 class="card-title mb-0">Level User</h3>
                        </div>
                        <div class="col-12 col-md">
                            <div class="d-flex flex-wrap justify-content-md-end align-items-center gap-2">
                                <form method="GET" action="{{ url('/admin/master/level/user') }}" class="d-flex flex-wrap align-items-center gap-2">
                                    ...
                                    <div class="input-group input-group-sm" style="width: 150px; mx-1">
                                ...
                                <a href="{{ url('/admin/master/level/list')}}" type="button" class="btn btn-info btn-sm m-1">List Level</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                        ...
                        <table id="data" class="table table-bordered table-hover" style="border-radius: 10px; min-width: 800px;">
                          <thead style="background-color: #578FCA; color: white;">
                            <tr>
                                ...
                                <th style="min-width: 200px; white-space: nowrap;">User</th>
                                <th style="min-width: 250px; white-space: nowrap;">Level</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="white-space: nowrap;">{{ $users->firstItem() + $key }}</td>
                            <td style="white-space: nowrap;">{{ $item->name }}</td>
                            <td style="white-space: nowrap;">
                                @foreach ($item->levels as $level)
                                <span class="badge" style="background-color: {{ $level->warna }}; margin-right: 5px;" data-color="{{ $level->warna }}">
                                    {{ $level->nama_level }}
                                </span>
                                @endforeach
                            </td>
