...
<div class="profile-container m-3">
    <div class="profile-image-container">
      <div class="profile-image" style="background-color: #f5f5f5; display: flex; align-items: center; justify-content: center;">
        <img src="{{ Auth::user()->foto_profil && Storage::exists(Auth::user()->foto_profil) ? Storage::url(Auth::user()->foto_profil) : asset('image/Avatar.png') }}" alt="Profile Image" class="img-fluid" style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">
      </div>
      <div class="edit-icon">
