                        ...
                        <form method="post" action="{{ url('/admin/quiz/update/' . $quiz->quiz_id) }}">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" class="form-control" value="{{ $quiz->judul }}" id="judul"
                                        name="judul" required>
                                </div>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="number" class="form-control" value="{{ $quiz->waktu_pengerjaan }}"
                                        id="waktu_pengerjaan" name="waktu_pengerjaan" required>
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    @endphp
                                    <input type="text" class="form-control" value="{{ $status }}" id="is_active"
                                        name="is_active" style="width: 50%" readonly>
                                </div>
                            ...
                            <tbody id="type-soal-body">
                                @foreach ($type_soal as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td> {{ $tipe }} </td>
                                        <td>
                                            <input min="0" type="number" style="max-width: 5vw"
                                                value="{{ $item->jumlah_soal }}" class="jumlah_soal"
                                                onchange="updateTypeSoal(this)" required>
                                        </td>
                                        <td>
                                            <input min="0" type="number" style="max-width: 8vw"
                                                value="{{ $item->skor_per_soal }}" class="skor_per_soal"
                                                onchange="updateTypeSoal(this)" required>
                                        </td>
                                        ...
                                        <td>
                                            <a href="{{ url('/admin/quiz/soal/' . $item->id) }}"
                                                class="kelola-soal-btn btn btn-primary">Kelola Soal</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
