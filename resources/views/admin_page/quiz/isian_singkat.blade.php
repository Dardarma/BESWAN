...
@section('content')
    ...
    <div class="row mx-2">
        ...
        <form method="POST" action="{{url('/admin/quiz/soal/create_soal')}}" id="form-soal" enctype="multipart/form-data">
            @csrf
            <div class="col-12"> 
                <div class="card mt-4">
                        ...
                        @foreach($soal_quiz as $soal)
                            <div class="card mb-4 shadow-sm soal-container">
                                <div class="card-body" style="background-color: rgb(224, 239, 244)">
                                    <input type="hidden" name="soal_quiz[{{ $soal->id }}][id]" value="{{ $soal->id }}">
                                    ...
                                    <input type="text" class="form-control mb-2" name="soal_quiz[{{ $soal->id }}][jawaban]" value="{{ $soal->jawaban_benar }}" >
