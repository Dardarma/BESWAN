        ...
        <div class="card">
          <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="card-tools d-flex align-items-center ml-auto">
                ...
                <!-- Add Level Button -->
                <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#add" >Add Video</button>
            </div>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <form id="delete-form-{{ $item->id }}" method="POST" style="display:inline;" action="{{ url('/admin/video/delete/'.$item->id) }}">
                        @csrf
                        @method('DELETE') 
        ...
        button.addEventListener('click', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.getElementById(`delete-form-${formId}`).submit(); // 🔥 ID form sudah sesuai
                }
            });
        });
    });
